...
var PAGE_DONE_CHECK_TIMEOUT = process.env.PAGE_DONE_CHECK_TIMEOUT || 500;

var RESOURCE_DOWNLOAD_TIMEOUT = process.env.RESOURCE_DOWNLOAD_TIMEOUT || 10 * 1000;

var WAIT_AFTER_LAST_REQUEST = process.env.WAIT_AFTER_LAST_REQUEST || 600;

var JS_CHECK_TIMEOUT = process.env.JS_CHECK_TIMEOUT || 400;

var JS_TIMEOUT = process.env.JS_TIMEOUT || 10 * 1000;

var NO_JS_EXECUTION_TIMEOUT = process.env.NO_JS_EXECUTION_TIMEOUT || 3000;

var EVALUATE_JAVASCRIPT_CHECK_TIMEOUT = process.env.EVALUATE_JAVASCRIPT_CHECK_TIMEOUT || 400;
...
server.createPage = function(req, res) {
    ...
    //console.log('createPage phantom = ', this.phantom);
...
server.onPhantomPageCreate = function(req, res) {
    ...
    //console.log('onPhantomPageCreate = ', this.phantom);
    //console.log('_this.options = ', _this.options);
    _this.options.logRequests = true;
...
server.checkIfPageIsDoneLoading = function(req, res) {
    ...
    console.log('checkIfPageIsDoneLoading');
